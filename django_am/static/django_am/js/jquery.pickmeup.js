...
(function ($) {
    ...
    function fill () {
        var options     = $(this).data('pickmeup-options'),
            ...
            current_cal = ((options.first_calendar != 'auto') ? options.first_calendar : Math.floor(options.calendars / 2)),
            date,
            data,
            header,
            year,
        ...
        if (el.hasClass('pmu-button')) {
            ...
            if (el.parent().is('nav')) {
                if (el.hasClass('pmu-month')) {
                    current_date.addMonths(instance_index - ((options.first_calendar != 'auto') ? options.first_calendar : Math.floor(options.calendars / 2)));
                ...
                if (root.hasClass('pmu-view-years')) {
                    ...
                    options.current.addMonths(((options.first_calendar != 'auto') ? options.first_calendar : Math.floor(options.calendars / 2)) - instance_index);
                    root.removeClass('pmu-view-months').addClass('pmu-view-days');
                } else {
